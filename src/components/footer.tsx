...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-6 md:mt-10 lg:mt-16 border-t border-white/30 dark:border-white/10 bg-white/30 dark:bg-white/5 backdrop-blur-md overflow-hidden -mx-4 md:mx-0 w-[calc(100%+2rem)] md:w-full">
