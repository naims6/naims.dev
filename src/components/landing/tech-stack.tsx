            ...
            >
              <div
                className={cn(
                  ...
                  "bg-transparent border-white/20 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.15)] hover:border-white/40 dark:hover:border-white/20"
                )}
              >
