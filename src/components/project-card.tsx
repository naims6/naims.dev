...
export function ProjectCard({ project: p, getTechIcon }: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="overflow-hidden flex flex-col gap-3 h-full bg-transparent backdrop-blur-md border border-white/20 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.15)] p-0 transition-all duration-300 hover:border-white/40 dark:hover:border-white/20 rounded-2xl group">
