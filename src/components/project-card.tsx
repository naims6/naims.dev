...
export function ProjectCard({ project: p, getTechIcon }: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="overflow-hidden flex flex-col gap-3 h-full bg-white/30 dark:bg-white/5 backdrop-blur-md border border-white/30 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.25)] p-0 transition-all duration-300 hover:border-white/50 dark:hover:border-white/20 rounded-2xl group">
